...
{ 
	...
	GPIO_InitStructure.GPIO_Pin  = GPIO_Pin_4 |GPIO_Pin_5|GPIO_Pin_7;//KEY0-KEY2
...
{	 
	...
	}else if(KEY_UP==1&&KEY_DOWM==1)key_up=1; 	    //&&KEY2==1&&WK_UP==0
 	return 0;// 无按键按下
}
